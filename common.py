...
TYPE_CODE_MAP: Dict[str, str] = {
    ...
    "AC68": "Gulfstream/Rockwell (Aero) Commander 680",
    ...
    "AS50": "Eurocopter AS350 Écureuil / AS550 Fennec",
    ...
    "B462": "BAe 146-200 / Avro RJ85",
    "B463": "BAe 146-300 / Avro RJ100",
    ...
    "BE76": "Beechcraft Model 76 Duchess",
    ...
    "S61": "Sikorsky S-61",
    "S65C": "Eurocopter (Aerospatiale) SA365C Dauphin 2",
    "S76": "Sikorsky S-76",
    "S92": "Sikorsky S-92",
    "SB20": "Saab 2000",
...
TYPE_CODE_MAP_SIMPLE: Dict[str, str] = {
    # "A19N": "Airbus A319neo",
    # "A20N": "Airbus A320neo",
    # "A21N": "Airbus A321neo",
    # "A306": "Airbus A300-600",
...
TYPE_CODE_BOEING_OVERLAP: Dict[str, str] = {
    "B37M": "Boeing 737",
    "B38M": "Boeing 737",
    "B39M": "Boeing 737",
    "B3XM": "Boeing 737",
